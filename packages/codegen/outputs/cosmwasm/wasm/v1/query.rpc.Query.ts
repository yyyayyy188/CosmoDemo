...
export const createRpcQueryMobxStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  class QueryContractsByCreatorStore {
    store = new QueryStore<QueryContractsByCreatorRequest, QueryContractsByCreatorResponse>(queryService?.contractsByCreator);
    contractsByCreator(request: QueryContractsByCreatorRequest) {
      return this.store.getData(request);
    }
  }
  return {
    ...
    /** Params gets the module params */QueryParamsStore,
    /** ContractsByCreator gets the contracts by creator */QueryContractsByCreatorStore
  };
};