...
export interface AccountAmino {
  /** unique identifier for this escrow account */
  id: AccountIDAmino | undefined;
  /** bech32 encoded account address of the owner of this escrow account */
  owner: string;
  /** current state of this escrow account */
  state: Account_State;
  /** unspent coins received from the owner's wallet */
  balance: DecCoinAmino | undefined;
  /** total coins spent by this account */
  transferred: DecCoinAmino | undefined;
  /** block height at which this account was last settled */
  settled_at: string;
  /**
   * bech32 encoded account address of the depositor.
...
export interface AccountSDKType {
  id: AccountIDSDKType | undefined;
  owner: string;
  state: Account_State;
  balance: DecCoinSDKType | undefined;
  transferred: DecCoinSDKType | undefined;
  settled_at: bigint;
  depositor: string;
  funds: DecCoinSDKType | undefined;
}
...
export interface FractionalPaymentAmino {
  account_id: AccountIDAmino | undefined;
  payment_id: string;
  owner: string;
  state: FractionalPayment_State;
  rate: DecCoinAmino | undefined;
  balance: DecCoinAmino | undefined;
...
export interface FractionalPaymentSDKType {
  account_id: AccountIDSDKType | undefined;
  payment_id: string;
  owner: string;
  state: FractionalPayment_State;
  rate: DecCoinSDKType | undefined;
  balance: DecCoinSDKType | undefined;
