...
export const GenesisState = {
  ...
  toJSON(message: GenesisState): JsonSafe<GenesisState> {
    ...
    message.lastInterestTime !== undefined && (obj.lastInterestTime = (message.lastInterestTime || BigInt(0)).toString());
    if (message.badDebts) {
  ...
  fromSDK(object: GenesisStateSDKType): GenesisState {
    return {
      ...
      adjustedBorrows: Array.isArray(object?.adjusted_borrows) ? object.adjusted_borrows.map((e: any) => AdjustedBorrow.fromSDK(e)) : [],
      collateral: Array.isArray(object?.collateral) ? object.collateral.map((e: any) => Collateral.fromSDK(e)) : [],
      reserves: Array.isArray(object?.reserves) ? object.reserves.map((e: any) => Coin.fromSDK(e)) : [],
      lastInterestTime: object?.last_interest_time,
      badDebts: Array.isArray(object?.bad_debts) ? object.bad_debts.map((e: any) => BadDebt.fromSDK(e)) : [],
      interestScalars: Array.isArray(object?.interest_scalars) ? object.interest_scalars.map((e: any) => InterestScalar.fromSDK(e)) : [],
      utokenSupply: Array.isArray(object?.utoken_supply) ? object.utoken_supply.map((e: any) => Coin.fromSDK(e)) : []
    };
  },
  toSDK(message: GenesisState): GenesisStateSDKType {
    ...
    if (message.adjustedBorrows) {
      obj.adjusted_borrows = message.adjustedBorrows.map(e => e ? AdjustedBorrow.toSDK(e) : undefined);
    } else {
      obj.adjusted_borrows = [];
    }
    if (message.collateral) {
      obj.collateral = message.collateral.map(e => e ? Collateral.toSDK(e) : undefined);
    } else {
      obj.collateral = [];
    }
    if (message.reserves) {
      obj.reserves = message.reserves.map(e => e ? Coin.toSDK(e) : undefined);
    } else {
      obj.reserves = [];
    }
    obj.last_interest_time = message.lastInterestTime;
    if (message.badDebts) {
      obj.bad_debts = message.badDebts.map(e => e ? BadDebt.toSDK(e) : undefined);
    } else {
      obj.bad_debts = [];
    }
    if (message.interestScalars) {
      obj.interest_scalars = message.interestScalars.map(e => e ? InterestScalar.toSDK(e) : undefined);
    } else {
      obj.interest_scalars = [];
    }
    if (message.utokenSupply) {
      obj.utoken_supply = message.utokenSupply.map(e => e ? Coin.toSDK(e) : undefined);
    } else {
      obj.utoken_supply = [];
    }
    return obj;
...
export const AdjustedBorrow = {
  ...
  toJSON(message: AdjustedBorrow): JsonSafe<AdjustedBorrow> {
    const obj: any = {};
  ...
  fromSDK(object: AdjustedBorrowSDKType): AdjustedBorrow {
    return {
      address: object?.address,
      amount: object.amount ? DecCoin.fromSDK(object.amount) : undefined
    };
  },
  toSDK(message: AdjustedBorrow): AdjustedBorrowSDKType {
    const obj: any = {};
    obj.address = message.address;
    message.amount !== undefined && (obj.amount = message.amount ? DecCoin.toSDK(message.amount) : undefined);
    return obj;
  },
...
export const Collateral = {
  ...
  toJSON(message: Collateral): JsonSafe<Collateral> {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
  ...
  fromSDK(object: CollateralSDKType): Collateral {
    return {
      address: object?.address,
      amount: object.amount ? Coin.fromSDK(object.amount) : undefined
    };
  },
  toSDK(message: Collateral): CollateralSDKType {
    const obj: any = {};
    obj.address = message.address;
...
export const BadDebt = {
  ...
  toJSON(message: BadDebt): JsonSafe<BadDebt> {
    const obj: any = {};
    message.address !== undefined && (obj.address = message.address);
  ...
  fromSDK(object: BadDebtSDKType): BadDebt {
    return {
      address: object?.address,
      denom: object?.denom
    };
  },
  toSDK(message: BadDebt): BadDebtSDKType {
    const obj: any = {};
    obj.address = message.address;
...
export const InterestScalar = {
  ...
  toJSON(message: InterestScalar): JsonSafe<InterestScalar> {
    const obj: any = {};
    message.denom !== undefined && (obj.denom = message.denom);
  ...
  fromSDK(object: InterestScalarSDKType): InterestScalar {
    return {
      denom: object?.denom,
      scalar: object?.scalar
    };
  },
  toSDK(message: InterestScalar): InterestScalarSDKType {
    const obj: any = {};
    obj.denom = message.denom;
