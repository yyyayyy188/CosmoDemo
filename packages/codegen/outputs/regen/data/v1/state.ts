...
export const DataID = {
  ...
  toJSON(message: DataID): JsonSafe<DataID> {
    const obj: any = {};
  ...
  fromSDK(object: DataIDSDKType): DataID {
    return {
      id: object?.id,
      iri: object?.iri
    };
  },
  toSDK(message: DataID): DataIDSDKType {
    const obj: any = {};
    obj.id = message.id;
    obj.iri = message.iri;
    return obj;
...
export const DataAnchor = {
  ...
  toJSON(message: DataAnchor): JsonSafe<DataAnchor> {
    const obj: any = {};
    message.id !== undefined && (obj.id = base64FromBytes(message.id !== undefined ? message.id : new Uint8Array()));
  ...
  fromSDK(object: DataAnchorSDKType): DataAnchor {
    return {
      id: object?.id,
      timestamp: object.timestamp ?? undefined
    };
  },
  toSDK(message: DataAnchor): DataAnchorSDKType {
    const obj: any = {};
    obj.id = message.id;
...
export const DataAttestor = {
  ...
  toJSON(message: DataAttestor): JsonSafe<DataAttestor> {
    const obj: any = {};
    message.id !== undefined && (obj.id = base64FromBytes(message.id !== undefined ? message.id : new Uint8Array()));
  ...
  fromSDK(object: DataAttestorSDKType): DataAttestor {
    return {
      id: object?.id,
  ...
  toSDK(message: DataAttestor): DataAttestorSDKType {
    const obj: any = {};
    obj.id = message.id;
...
export const ResolverInfo = {
  ...
  toJSON(message: ResolverInfo): JsonSafe<ResolverInfo> {
    const obj: any = {};
  ...
  fromSDK(object: ResolverInfoSDKType): ResolverInfo {
    return {
      id: object?.id,
      url: object?.url,
  ...
  toSDK(message: ResolverInfo): ResolverInfoSDKType {
    const obj: any = {};
    obj.id = message.id;
    obj.url = message.url;
...
export const DataResolver = {
  ...
  toJSON(message: DataResolver): JsonSafe<DataResolver> {
    const obj: any = {};
    message.id !== undefined && (obj.id = base64FromBytes(message.id !== undefined ? message.id : new Uint8Array()));
  ...
  fromSDK(object: DataResolverSDKType): DataResolver {
    return {
      id: object?.id,
      resolverId: object?.resolver_id
    };
  },
  toSDK(message: DataResolver): DataResolverSDKType {
    const obj: any = {};
    obj.id = message.id;
