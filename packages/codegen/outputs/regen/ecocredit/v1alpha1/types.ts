...
export const Params = {
  ...
  fromSDK(object: ParamsSDKType): Params {
    return {
      ...
      basketCreationFee: Array.isArray(object?.basket_creation_fee) ? object.basket_creation_fee.map((e: any) => Coin.fromSDK(e)) : []
    };
  },
  toSDK(message: Params): ParamsSDKType {
    ...
    if (message.basketCreationFee) {
      obj.basket_creation_fee = message.basketCreationFee.map(e => e ? Coin.toSDK(e) : undefined);
    } else {
...
export const CreditTypeSeq = {
  ...
  toJSON(message: CreditTypeSeq): JsonSafe<CreditTypeSeq> {
    const obj: any = {};
    message.abbreviation !== undefined && (obj.abbreviation = message.abbreviation);
  ...
  fromSDK(object: CreditTypeSeqSDKType): CreditTypeSeq {
    return {
      abbreviation: object?.abbreviation,
      seqNumber: object?.seq_number
    };
  },
  toSDK(message: CreditTypeSeq): CreditTypeSeqSDKType {
    const obj: any = {};
    obj.abbreviation = message.abbreviation;
    obj.seq_number = message.seqNumber;
    return obj;
  },
