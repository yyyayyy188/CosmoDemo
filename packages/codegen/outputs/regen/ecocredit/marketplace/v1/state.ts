...
export const SellOrder = {
  ...
  toJSON(message: SellOrder): JsonSafe<SellOrder> {
    const obj: any = {};
  ...
  fromSDK(object: SellOrderSDKType): SellOrder {
    return {
      id: object?.id,
  ...
  toSDK(message: SellOrder): SellOrderSDKType {
    const obj: any = {};
    obj.id = message.id;
...
export const AllowedDenom = {
  ...
  toJSON(message: AllowedDenom): JsonSafe<AllowedDenom> {
    const obj: any = {};
  ...
  fromSDK(object: AllowedDenomSDKType): AllowedDenom {
    return {
  ...
  toSDK(message: AllowedDenom): AllowedDenomSDKType {
    const obj: any = {};
...
export const Market = {
  ...
  fromAmino(object: MarketAmino): Market {
    ...
    if (object.credit_type !== undefined && object.credit_type !== null) {
      message.creditType = object.credit_type;
    }
    if (object.bank_denom !== undefined && object.bank_denom !== null) {
      message.bankDenom = object.bank_denom;
    }
  ...
  toAmino(message: Market): MarketAmino {
    const obj: any = {};
    obj.id = message.id !== BigInt(0) ? message.id.toString() : undefined;
    obj.credit_type = message.creditType === "" ? undefined : message.creditType;
    obj.bank_denom = message.bankDenom === "" ? undefined : message.bankDenom;
