...
export const MsgSell = {
  ...
  toJSON(message: MsgSell): JsonSafe<MsgSell> {
    const obj: any = {};
  ...
  fromSDK(object: MsgSellSDKType): MsgSell {
    return {
      owner: object?.owner,
      orders: Array.isArray(object?.orders) ? object.orders.map((e: any) => MsgSell_Order.fromSDK(e)) : []
    };
  },
  toSDK(message: MsgSell): MsgSellSDKType {
    const obj: any = {};
    obj.owner = message.owner;
    if (message.orders) {
      obj.orders = message.orders.map(e => e ? MsgSell_Order.toSDK(e) : undefined);
    } else {
      obj.orders = [];
    }
    return obj;
...
export const MsgSell_Order = {
  ...
  toJSON(message: MsgSell_Order): JsonSafe<MsgSell_Order> {
    const obj: any = {};
  ...
  fromSDK(object: MsgSell_OrderSDKType): MsgSell_Order {
    return {
      batchDenom: object?.batch_denom,
      quantity: object?.quantity,
      askPrice: object.ask_price ? Coin.fromSDK(object.ask_price) : undefined,
      disableAutoRetire: object?.disable_auto_retire,
      expiration: object.expiration ?? undefined
    };
  },
  toSDK(message: MsgSell_Order): MsgSell_OrderSDKType {
    const obj: any = {};
    obj.batch_denom = message.batchDenom;
    obj.quantity = message.quantity;
    message.askPrice !== undefined && (obj.ask_price = message.askPrice ? Coin.toSDK(message.askPrice) : undefined);
...
export const MsgSellResponse = {
  ...
  toJSON(message: MsgSellResponse): JsonSafe<MsgSellResponse> {
    const obj: any = {};
  ...
  fromSDK(object: MsgSellResponseSDKType): MsgSellResponse {
    return {
      sellOrderIds: Array.isArray(object?.sell_order_ids) ? object.sell_order_ids.map((e: any) => e) : []
    };
  },
  toSDK(message: MsgSellResponse): MsgSellResponseSDKType {
    const obj: any = {};
    if (message.sellOrderIds) {
...
export const MsgUpdateSellOrders = {
  ...
  toJSON(message: MsgUpdateSellOrders): JsonSafe<MsgUpdateSellOrders> {
    const obj: any = {};
    message.owner !== undefined && (obj.owner = message.owner);
    if (message.updates) {
  ...
  fromSDK(object: MsgUpdateSellOrdersSDKType): MsgUpdateSellOrders {
    return {
      owner: object?.owner,
      updates: Array.isArray(object?.updates) ? object.updates.map((e: any) => MsgUpdateSellOrders_Update.fromSDK(e)) : []
    };
  },
  toSDK(message: MsgUpdateSellOrders): MsgUpdateSellOrdersSDKType {
    const obj: any = {};
    obj.owner = message.owner;
    if (message.updates) {
      obj.updates = message.updates.map(e => e ? MsgUpdateSellOrders_Update.toSDK(e) : undefined);
    } else {
      obj.updates = [];
    }
    return obj;
...
export const MsgUpdateSellOrders_Update = {
  ...
  fromJSON(object: any): MsgUpdateSellOrders_Update {
    return {
      ...
      disableAutoRetire: isSet(object.disableAutoRetire) ? Boolean(object.disableAutoRetire) : false,
      newExpiration: isSet(object.newExpiration) ? new Date(object.newExpiration) : undefined
    };
  },
  toJSON(message: MsgUpdateSellOrders_Update): JsonSafe<MsgUpdateSellOrders_Update> {
    const obj: any = {};
  ...
  fromSDK(object: MsgUpdateSellOrders_UpdateSDKType): MsgUpdateSellOrders_Update {
    return {
      sellOrderId: object?.sell_order_id,
      newQuantity: object?.new_quantity,
      newAskPrice: object.new_ask_price ? Coin.fromSDK(object.new_ask_price) : undefined,
      disableAutoRetire: object?.disable_auto_retire,
      newExpiration: object.new_expiration ?? undefined
    };
  },
  toSDK(message: MsgUpdateSellOrders_Update): MsgUpdateSellOrders_UpdateSDKType {
    const obj: any = {};
    obj.sell_order_id = message.sellOrderId;
    obj.new_quantity = message.newQuantity;
    message.newAskPrice !== undefined && (obj.new_ask_price = message.newAskPrice ? Coin.toSDK(message.newAskPrice) : undefined);
    obj.disable_auto_retire = message.disableAutoRetire;
    message.newExpiration !== undefined && (obj.new_expiration = message.newExpiration ?? undefined);
    return obj;
  },
...
export const MsgUpdateSellOrdersResponse = {
  ...
  toJSON(_: MsgUpdateSellOrdersResponse): JsonSafe<MsgUpdateSellOrdersResponse> {
    const obj: any = {};
    return obj;
  },
  ...
  fromSDK(_: MsgUpdateSellOrdersResponseSDKType): MsgUpdateSellOrdersResponse {
    return {};
  },
  toSDK(_: MsgUpdateSellOrdersResponse): MsgUpdateSellOrdersResponseSDKType {
    const obj: any = {};
    return obj;
  },
...
export const MsgCancelSellOrder = {
  ...
  toJSON(message: MsgCancelSellOrder): JsonSafe<MsgCancelSellOrder> {
    const obj: any = {};
  ...
  fromSDK(object: MsgCancelSellOrderSDKType): MsgCancelSellOrder {
    return {
      seller: object?.seller,
      sellOrderId: object?.sell_order_id
    };
  },
  toSDK(message: MsgCancelSellOrder): MsgCancelSellOrderSDKType {
    const obj: any = {};
...
export const MsgCancelSellOrderResponse = {
  ...
  toJSON(_: MsgCancelSellOrderResponse): JsonSafe<MsgCancelSellOrderResponse> {
    const obj: any = {};
    return obj;
  },
  ...
  fromSDK(_: MsgCancelSellOrderResponseSDKType): MsgCancelSellOrderResponse {
    return {};
  },
  toSDK(_: MsgCancelSellOrderResponse): MsgCancelSellOrderResponseSDKType {
    const obj: any = {};
    return obj;
  },
...
export const MsgBuyDirect = {
  ...
  toJSON(message: MsgBuyDirect): JsonSafe<MsgBuyDirect> {
    const obj: any = {};
  ...
  fromSDK(object: MsgBuyDirectSDKType): MsgBuyDirect {
    return {
      buyer: object?.buyer,
      orders: Array.isArray(object?.orders) ? object.orders.map((e: any) => MsgBuyDirect_Order.fromSDK(e)) : []
    };
  },
  toSDK(message: MsgBuyDirect): MsgBuyDirectSDKType {
    const obj: any = {};
    obj.buyer = message.buyer;
    if (message.orders) {
      obj.orders = message.orders.map(e => e ? MsgBuyDirect_Order.toSDK(e) : undefined);
    } else {
      obj.orders = [];
    }
    return obj;
...
export const MsgBuyDirect_Order = {
  ...
  toJSON(message: MsgBuyDirect_Order): JsonSafe<MsgBuyDirect_Order> {
    const obj: any = {};
    message.sellOrderId !== undefined && (obj.sellOrderId = (message.sellOrderId || BigInt(0)).toString());
    message.quantity !== undefined && (obj.quantity = message.quantity);
  ...
  fromSDK(object: MsgBuyDirect_OrderSDKType): MsgBuyDirect_Order {
    return {
      sellOrderId: object?.sell_order_id,
      quantity: object?.quantity,
      bidPrice: object.bid_price ? Coin.fromSDK(object.bid_price) : undefined,
      disableAutoRetire: object?.disable_auto_retire,
      retirementJurisdiction: object?.retirement_jurisdiction
    };
  },
  toSDK(message: MsgBuyDirect_Order): MsgBuyDirect_OrderSDKType {
    const obj: any = {};
    obj.sell_order_id = message.sellOrderId;
    obj.quantity = message.quantity;
    message.bidPrice !== undefined && (obj.bid_price = message.bidPrice ? Coin.toSDK(message.bidPrice) : undefined);
    obj.disable_auto_retire = message.disableAutoRetire;
...
export const MsgBuyDirectResponse = {
  ...
  toJSON(_: MsgBuyDirectResponse): JsonSafe<MsgBuyDirectResponse> {
    const obj: any = {};
    return obj;
  },
  ...
  fromSDK(_: MsgBuyDirectResponseSDKType): MsgBuyDirectResponse {
    return {};
  },
  toSDK(_: MsgBuyDirectResponse): MsgBuyDirectResponseSDKType {
    const obj: any = {};
    return obj;
  },
