  ...
  return {
    ...
    regen: {
      data: {
        ...
        v1alpha2: (await import("./data/v1alpha2/query.rpc.Query")).createRpcQueryExtension(client)
      },
      ecocredit: {
        basket: {
          v1: (await import("./ecocredit/basket/v1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        marketplace: {
          v1: (await import("./ecocredit/marketplace/v1/query.rpc.Query")).createRpcQueryExtension(client)
        },
        v1: (await import("./ecocredit/v1/query.rpc.Query")).createRpcQueryExtension(client),
        v1alpha1: (await import("./ecocredit/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      group: {
        v1alpha1: (await import("./group/v1alpha1/query.rpc.Query")).createRpcQueryExtension(client)
      }
    }
  };
};