...
export const createRpcQueryHooks = (rpc: ProtobufRpcClient | undefined) => {
  ...
  return {
    /** ModuleAccountBalance RPC returns the claim module account balance */useModuleAccountBalance,
    /** Params RPC returns claim module params */useParams,
    /** ClaimRecord RPC returns claim record for an address */useClaimRecord,
    /** ClaimableForAction RPC returns claimable amount for an action of an address */useClaimableForAction,
    /** TotalClaimable RPC returns total claimable amount for address */useTotalClaimable
  };
};
export const createRpcQueryMobxStores = (rpc: ProtobufRpcClient | undefined) => {
  ...
  return {
    /** ModuleAccountBalance RPC returns the claim module account balance */QueryModuleAccountBalanceStore,
    /** Params RPC returns claim module params */QueryParamsStore,
    /** ClaimRecord RPC returns claim record for an address */QueryClaimRecordStore,
    /** ClaimableForAction RPC returns claimable amount for an action of an address */QueryClaimableForActionStore,
    /** TotalClaimable RPC returns total claimable amount for address */QueryTotalClaimableStore
  };
};