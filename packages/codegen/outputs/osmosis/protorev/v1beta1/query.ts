...
export interface QueryGetProtoRevStatisticsByPoolResponseAmino {
   ...
   * swap on a given pool and the profits from the trades
   */
  statistics?: PoolStatisticsAmino | undefined;
}
...
export interface QueryGetProtoRevStatisticsByPoolResponseSDKType {
  statistics?: PoolStatisticsSDKType | undefined;
}
/**
...
export const QueryGetProtoRevStatisticsByPoolRequest = {
  ...
  toJSON(message: QueryGetProtoRevStatisticsByPoolRequest): JsonSafe<QueryGetProtoRevStatisticsByPoolRequest> {
    const obj: any = {};
...
export const QueryGetProtoRevStatisticsByPoolResponse = {
  ...
  toJSON(message: QueryGetProtoRevStatisticsByPoolResponse): JsonSafe<QueryGetProtoRevStatisticsByPoolResponse> {
    const obj: any = {};
...
export const QueryGetProtoRevAllStatisticsRequest = {
  ...
  toJSON(_: QueryGetProtoRevAllStatisticsRequest): JsonSafe<QueryGetProtoRevAllStatisticsRequest> {
    const obj: any = {};
    return obj;
  },
...
export const QueryGetProtoRevAllStatisticsResponse = {
  ...
  toJSON(message: QueryGetProtoRevAllStatisticsResponse): JsonSafe<QueryGetProtoRevAllStatisticsResponse> {
    const obj: any = {};
