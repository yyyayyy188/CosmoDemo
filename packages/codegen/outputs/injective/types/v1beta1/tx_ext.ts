...
export const ExtensionOptionsWeb3Tx = {
  ...
  fromSDK(object: ExtensionOptionsWeb3TxSDKType): ExtensionOptionsWeb3Tx {
    return {
      typedDataChainID: object?.typedDataChainID,
      feePayer: object?.feePayer,
      feePayerSig: object?.feePayerSig
    };
  },
  toSDK(message: ExtensionOptionsWeb3Tx): ExtensionOptionsWeb3TxSDKType {
    const obj: any = {};
